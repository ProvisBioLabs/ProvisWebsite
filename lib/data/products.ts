...
export const products: Product[] = [
    {
        ...
        category: 'api',
        grade: 'GMP Grade',
        tagline: 'India\'s Leading Bulk API Supplier',
        ...
        casNumber: '9015-68-3',
        keyFeatures: ['High purity & Potency', 'Low endotoxin levels', 'Manufactured under WHO-GMP', 'Scalable production capacity'],
    ...
    },
    {
        ...
        category: 'api',
        grade: 'GMP Grade',
        tagline: 'PEGylated oncology enzyme for enhanced treatment outcomes',
    ...
    },
    {
        ...
        category: 'api',
        grade: 'GMP Grade',
        tagline: 'Lyophilized & Liquid Bulk Available',
