...
export default function PartnersContent() {
    ...
    return (
        <section className="bg-[#FAFAFA] min-h-screen pb-24 font-outfit">
            {/* Hero Header */}
            <div className="bg-[#1E3A8A] pt-12 pb-20 px-4 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-12 relative z-20">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="mt-16 bg-white rounded-3xl p-8 sm:p-12 shadow-[0_20px_60px_rgba(30,58,138,0.08)] border border-[#E2E8F0] relative overflow-hidden"
                >
                    <div className="text-center mb-12">
                        <h3 className="text-2xl sm:text-3xl lg:text-4xl font-black text-[#1E3A8A] mb-4">Partner With Us</h3>
                        <p className="text-[#64748B] max-w-2xl mx-auto text-lg leading-relaxed">
                            We are continually expanding our global reach. If you are interested in becoming an authorized partner, please fill out the form below.
                        </p>
                    </div>
                    <div className="max-w-3xl mx-auto">
                        <ContactForm prefilledInterest="Partnership" />
                    </div>
                </motion.div>
            </div>
        </section>
