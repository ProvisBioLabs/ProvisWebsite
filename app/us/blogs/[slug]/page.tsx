...
import BlogPostContent from "@/app/us/blogs/[slug]/BlogPostContent"; // Re-validated absolute import
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
    ...
    return {
        ...
        alternates: {
            canonical: `https://www.provisbiolabs.com/us/blogs/${blog.slug}`,
            languages: {
                'en-US': `https://www.provisbiolabs.com/us/blogs/${blog.slug}`,
                'en-GB': `https://www.provisbiolabs.com/us/blogs/${blog.slug}`,
                'en-SG': `https://www.provisbiolabs.com/us/blogs/${blog.slug}`,
                'en-KR': `https://www.provisbiolabs.com/us/blogs/${blog.slug}`,
                'en-NL': `https://www.provisbiolabs.com/us/blogs/${blog.slug}`,
                'en-FR': `https://www.provisbiolabs.com/us/blogs/${blog.slug}`,
                'en-CA': `https://www.provisbiolabs.com/us/blogs/${blog.slug}`,
                'x-default': `https://www.provisbiolabs.com/us/blogs/${blog.slug}`,
            }
        },
        openGraph: {
            title: blog.title,
...
export default async function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    if (slug !== blog.slug) {
        permanentRedirect(`/us/blogs/${blog.slug}`);
    }
    ...
    const jsonLd = {
        ...
        mainEntityOfPage: {
            '@type': 'WebPage',
            '@id': `https://www.provisbiolabs.com/us/blogs/${blog.slug}`
        },
        author: {
            '@type': 'Organization',
            name: 'Provis Biolabs',
        ...
        itemListElement: [
            {
                ...
                position: 1,
                name: 'Home',
                item: 'https://www.provisbiolabs.com/us'
            },
            {
                '@type': 'ListItem',
                position: 2,
                name: 'News & Insights',
                item: 'https://www.provisbiolabs.com/us/blogs'
            },
            {
                '@type': 'ListItem',
                position: 3,
                name: blog.title,
                item: `https://www.provisbiolabs.com/us/blogs/${blog.slug}`
            }
        ]
    };
