        ...
        <>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                        <motion.div {...fade()}>
                            ...
                            <div className="flex flex-wrap gap-4">
                                <Link href="/us/contact" className="inline-flex items-center gap-2 px-8 py-4 rounded-xl text-sm font-bold text-white bg-[#F26522] hover:bg-[#d95a1e] transition-all duration-300 shadow-[0_8px_24px_rgba(242,101,34,0.25)]">
            ...
            <section className="py-24 bg-white border-t border-[#E2E8F0]">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <motion.div {...fade(0.3)}>
                        <Link href="/us/contact" className="inline-flex items-center gap-2 px-10 py-4 rounded-xl font-bold text-white bg-[#F26522] hover:bg-[#d95a1e] transition-all shadow-[0_8px_24px_rgba(242,101,34,0.25)]">
