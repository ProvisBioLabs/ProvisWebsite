...
export const metadata: Metadata = {
    title: 'Terms and Conditions USA | Provis Biolabs',
    description: 'Terms and conditions governing the use of the Provis Biolabs USA website and services.',
    alternates: {
        canonical: 'https://www.provisbiolabs.com/us/terms'
    }
};
            ...
            <section className="pt-36 pb-20 relative">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="bg-white rounded-3xl p-8 md:p-12 border border-[#E2E8F0] shadow-sm">
                        ...
                        <p className="text-[#475569] leading-relaxed mb-8">
                            Your use of this website is also governed by our <a href="/us/privacy-policy" className="text-[#F26522] underline">Privacy Policy</a>, which is incorporated into these Terms by reference. Please review the Privacy Policy to understand our data practices.
                        </p>
