...
import { products } from "../../../lib/data/usProducts";
...
const sitePages: SearchItem[] = [
    { type: "page", title: "About Provis Biolabs", subtitle: "Company overview, vision & mission", href: "/us/about", keywords: "about company vision mission values", icon: "page" },
    { type: "page", title: "CDMO Services", subtitle: "Contract development & manufacturing", href: "/us/cdmo", keywords: "cdmo contract manufacturing development outsourcing", icon: "page" },

    { type: "page", title: "Science & Technology", subtitle: "Our R&D capabilities", href: "/us/science", keywords: "science technology research development innovation", icon: "page" },
    { type: "page", title: "Careers", subtitle: "Join the Provis Biolabs team", href: "/us/careers", keywords: "careers jobs hiring recruitment", icon: "page" },
    { type: "page", title: "Contact Us", subtitle: "Get in touch for business enquiries", href: "/us/contact", keywords: "contact business enquiry partner", icon: "page" },
    { type: "page", title: "News & Events", subtitle: "Corporate news and milestones", href: "/us/news-events", keywords: "news events press release milestones", icon: "page" },
    { type: "page", title: "Partners", subtitle: "Our global distribution partners", href: "/us/partners", keywords: "partners distributors global international", icon: "page" },
];
...
// MAIN COMPONENT
// -------------------------------------------------------------------
export default function USGlobalSearch() {
