                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-start">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4">
                            <Link
                                href="/us/cdmo"
                                className="inline-block px-8 py-4 rounded-full font-bold text-white bg-[#F26522] hover:bg-[#E85B18] shadow-[0_8px_30px_rgb(242,101,34,0.3)] hover:-translate-y-0.5 transition-all duration-300"
                            >
                            ...
                            <Link
                                href="/us/contact"
                                className="group px-8 py-4 rounded-full font-bold text-[#1E3A8A] bg-white hover:bg-gray-50 border border-[#E2E8F0] transition-all flex items-center justify-center gap-2 shadow-sm"
                            >
                                Get a Quote
                            </Link>
                        </div>
