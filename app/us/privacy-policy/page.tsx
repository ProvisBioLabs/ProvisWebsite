...
export const metadata: Metadata = {
    title: "Privacy Policy USA | Provis Biolabs",
    description: "Learn how Provis Biolabs USA collects, uses and protects your personal information when you visit our website or engage with our services.",
    alternates: {
        canonical: "https://www.provisbiolabs.com/us/privacy-policy"
    }
};
            ...
            <section className="pt-36 pb-20 relative">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="bg-white rounded-3xl p-8 md:p-12 border border-[#E2E8F0] shadow-sm prose prose-slate max-w-none">
                        ...
                        <p className="text-[#475569] leading-relaxed mb-8">
                            You can control or disable cookies through your browser settings. However, disabling certain cookies may affect the functionality of some parts of our website. For more details, please refer to our <a href="/us/cookie-policy" className="text-[#F26522] underline">Cookie Policy</a>.
                        </p>
