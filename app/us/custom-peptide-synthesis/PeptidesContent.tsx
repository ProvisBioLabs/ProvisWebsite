...
const capabilities = [
    ...
    { title: "Flexible Quantities", desc: "From milligram R&D samples to kilogram-scale commercial batches, we cater to diverse peptide synthesis needs with precision." },
...
const analyticalMethods = [
    ...
    { name: "Endotoxin & Moisture Testing", desc: "Essential for GMP and in-vivo clinical applications." }
];
...
const keyFeatures = [
    ...
    "WHO-GMP compliant facilities in India & global US support",
        ...
        <>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="max-w-3xl">
                            <motion.h1 {...fade(0.1)} className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#1E3A8A] leading-tight mb-4">
                                GMP Custom Peptide Synthesis
                            </motion.h1>
                            <motion.div {...fade(0.3)} className="space-y-4 text-[#475569] text-base leading-relaxed mb-10">
                                <p>We provide end-to-end custom peptide synthesis services for pharmaceutical, biotechnology and academic research teams in North America and worldwide. Using advanced Fmoc-based solid-phase peptide synthesis and rigorous quality control systems, we deliver peptides ranging from simple linear sequences to complex cyclic, bridged and PEGylated constructs with high purity and reliability.</p>
                            </motion.div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <motion.div {...fade(0.1)}>
                            ...
                            <h2 className="text-3xl sm:text-4xl font-bold text-[#1E3A8A] mb-6">
                                Gram-to-Kilogram Custom Manufacturing & Quality Control
                            </h2>
            ...
            <section className="py-20 bg-[#F8FAFC] border-t border-[#E2E8F0]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div {...fade(0.1)} className="text-center max-w-3xl mx-auto mb-16">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#EFF6FF] text-[#1E3A8A] text-xs font-bold uppercase tracking-wider mb-4 border border-[#BFDBFE]">
                            <Microscope className="w-4 h-4 text-[#F26522]" />
                            Analytical Rigor
                        </div>
                        <h2 className="text-3xl sm:text-4xl font-bold text-[#1E3A8A] mb-4">
                        ...
                        <p className="text-[#475569] text-base leading-relaxed">
                            Every custom peptide batch is supported by exhaustive analytical testing, ensuring absolute sequence integrity and purity for GMP custom peptide synthesis and research applications.
                        </p>
                    </motion.div>
                    ...
                    <div className="grid md:grid-cols-4 gap-6">
                        {analyticalMethods.map((method, i) => (
                            <motion.div
                                key={method.name}
                                {...fade(0.1 + i * 0.1)}
                                className="p-6 rounded-2xl bg-white border border-[#E2E8F0] shadow-sm hover:border-[#1E3A8A]/30 transition-all duration-300"
                            >
                                <h3 className="text-lg font-bold text-[#1E3A8A] mb-3">{method.name}</h3>
                                <p className="text-sm text-[#64748B] leading-relaxed">{method.desc}</p>
                            </motion.div>
                        ))}
                    </div>
                </div>
