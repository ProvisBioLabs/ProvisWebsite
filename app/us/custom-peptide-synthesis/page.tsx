...
export const metadata: Metadata = {
    title: "Custom Peptide Synthesis Manufacturing USA & GMP Services | Provis Biolabs",
    description: "Premium Custom Peptide Synthesis services in the USA at Provis Biolabs. We provide GMP manufacturing, >99% purity and scale from grams to kilograms for clinical and commercial applications.",
    alternates: {
