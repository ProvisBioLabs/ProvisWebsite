...
export const metadata: Metadata = {
    title: 'Cookie Policy USA | Provis Biolabs',
    description: 'Learn about how Provis Biolabs USA uses cookies and similar technologies to enhance your experience.',
    alternates: {
        canonical: 'https://www.provisbiolabs.com/us/cookie-policy'
    }
};
