...
export const metadata = {
    ...
    alternates: {
        ...
        languages: {
            ...
            'en-NL': 'https://www.provisbiolabs.com/careers',
            'en-FR': 'https://www.provisbiolabs.com/careers',
            'en-CA': 'https://www.provisbiolabs.com/careers',
            'x-default': 'https://www.provisbiolabs.com/careers',
        }
    },
    openGraph: {
        title: "Biotechnology Careers & Jobs | Provis Biolabs",
...
const breadcrumbJsonLd = {
    ...
    itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Careers', item: 'https://www.provisbiolabs.com/careers' }
    ]
};
