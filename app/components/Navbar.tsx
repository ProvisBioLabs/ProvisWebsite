        ...
        columns: [
            {
                ...
                items: [
                    { name: 'L-Asparaginase Bulk', href: '/l-asparaginase' },
                    { name: 'Pegaspargase Bulk', href: '/pegaspargase' },
                    { name: 'Streptokinase Bulk', href: '/streptokinase' },
                    { name: 'Sodium Hyaluronate', href: '/sodium-hyaluronate' },
                ],
            },
            {
                ...
                center: true,
                items: [
                    { name: 'Provinase®', href: '/provinase' },
                    { name: 'Recombinant Human Albumin', href: '/recombinant-albumin' },
                    { name: 'Trypsin ', href: '/trypsin' },
                    { name: 'Carboxypeptidase B', href: '/carboxypeptidase-b' },
                    { name: 'PNGase F', href: '/pngase-f' },
                    { name: 'PNGase F Flash™', href: '/pngase-f-flash' },
                    { name: 'Streptavidin', href: '/streptavidin' },
                    { name: 'Enterokinase', href: '/enterokinase' },
                    { name: 'Kex2 Protease', href: '/kex2-protease' },
