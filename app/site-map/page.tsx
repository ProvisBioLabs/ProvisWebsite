                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li>
                                <Link href="/cdmo" className="text-[#1E3A8A] font-bold hover:text-[#F26522] transition-colors">CDMO Services</Link>
                                <ul className="pl-4 mt-2 space-y-2 border-l border-gray-100">
                                    {cdmoServices.map(p => (
                                        <li key={p.slug}>
                                            <Link href={`/${p.slug}`} className="text-gray-500 text-sm hover:text-[#F26522] transition-colors block">
                                                {p.name}
                                            </Link>
                                        </li>
                                    ))}
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li>
                                <Link href="/products/bio-apis" className="text-[#1E3A8A] font-bold hover:text-[#F26522] transition-colors">Bio-APIs</Link>
                                <ul className="pl-4 mt-2 space-y-2 border-l border-gray-100">
                                    {apis.map(p => (
                                        <li key={p.slug}>
                                            <Link href={`/${p.slug}`} className="text-gray-500 text-sm hover:text-[#F26522] transition-colors block">
                            ...
                            <li className="pt-2">
                                <Link href="/products/recombinant-bio-reagents" className="text-[#1E3A8A] font-bold hover:text-[#F26522] transition-colors">Recombinant Bio-Reagents</Link>
                                <ul className="pl-4 mt-2 space-y-2 border-l border-gray-100">
                                    {reagents.map(p => (
                                        <li key={p.slug}>
                                            <Link href={`/${p.slug}`} className="text-gray-500 text-sm hover:text-[#F26522] transition-colors block">
                            ...
                            <li className="pt-2">
                                <Link href="/custom-peptide-synthesis" className="text-[#1E3A8A] font-medium hover:text-[#F26522] transition-colors">Custom Peptide Synthesis</Link>
                            </li>
                            <li>
                                <Link href="/biosimilars" className="text-[#1E3A8A] font-medium hover:text-[#F26522] transition-colors">Biosimilars</Link>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li>
                                <Link href="/blogs" className="text-[#1E3A8A] font-bold hover:text-[#F26522] transition-colors">Blogs</Link>
                                <ul className="pl-4 mt-2 space-y-2 border-l border-gray-100 max-h-80 overflow-y-auto pr-1">
                                    {blogsData.map(b => (
                                        <li key={b.slug}>
                                            <Link href={`/blogs/${b.slug}`} className="text-gray-500 text-sm hover:text-[#F26522] transition-colors block truncate" title={b.title}>
                                                {b.title}
                                            </Link>
                                        </li>
                                    ))}
                            ...
                            <li className="pt-2"><Link href="/news" className="text-[#1E3A8A] font-medium hover:text-[#F26522] transition-colors">Company News</Link></li>
